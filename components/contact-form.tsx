  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          <label htmlFor="from_first_name" className="block text-sm font-medium text-gray-300">
            First Name
          </label>
          <Input
            id="from_first_name"
        ...
        <div>
          <label htmlFor="from_last_name" className="block text-sm font-medium text-gray-300">
            Last Name
          </label>
          <Input
            id="from_last_name"
